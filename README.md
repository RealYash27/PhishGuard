...
- **Advanced Heuristics**: homoglyph normalization, double-extension detection, URL shortener detection
- **Script Threat Detection**: identifies crypto-mining scripts, obfuscation, and hidden iframes
- **Credential Leak Warnings**: tooltip warnings for suspicious sites on password focus, and weak/breached password alerts (via HIBP k-anonymity)
...
- **OpenPhish** → public live feed (no key required)
- **AbuseIPDB** → requires API key for IP checks
